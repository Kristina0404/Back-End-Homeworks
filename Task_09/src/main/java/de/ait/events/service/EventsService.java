...
public interface EventsService {
   ...
   EventDto addEventToVenue(Long venueId, NewEventDto newEvent);
    ...
    EventDto updateEventInVenue(Long venueId, Long eventId, UpdateEventDto updateEvent);

    List<UserDto> addUserToEvent(Long eventId, UserToEventDto userData);

    List<UserDto> getUsersOfEvents(Long eventId);
}
